...
GROQ_MODEL = "llama-3.3-70b-versatile"  # Groq'ning eng kuchli modeli
...
def generate_work(work_type: str, topic: str, pages: int) -> str:
    ...
    if not GROQ_API_KEY:
        raise ValueError("GROQ_API_KEY topilmadi! .env faylga yoki Railway Variables ga kiriting.")
    ...
    payload = {
        ...
        "messages": [
            {
                "role": "system",
                "content": "Sen O'zbek tilida akademik ishlar yozishda mutaxassis bo'lgan yordamchisan. Har doim to'liq, sifatli va akademik uslubda yoz."
            },
            {
                "role": "user",
                "content": prompt
